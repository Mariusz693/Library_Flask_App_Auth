...
Revision ID: 2cf4727053e3
Revises: 
Create Date: 2021-12-27 19:42:16.853447
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('Admin', 'User', name='usertype'), server_default='User', nullable=False),
