...
Revision ID: f459029c9f50
Revises: 
Create Date: 2021-12-25 13:57:44.375515
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('Administrator', 'Użytkownik', name='usertype'), server_default='Użytkownik', nullable=False),
