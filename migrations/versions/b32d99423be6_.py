...
Revision ID: b32d99423be6
Revises: 
Create Date: 2021-12-23 11:23:55.734396
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('admin', 'client', name='usertype'), server_default='client', nullable=False),
